...
import { Package, AlertCircle, ShieldCheck, LogOut, ChevronRight } from "lucide-react";

const NAV = [
  { href: "/employee", icon: Package, label: "My Assets" },
  { href: "/employee/report", icon: AlertCircle, label: "Report Issue" },
];

export default function EmployeeSidebar({ username, fullName }: { username: string; fullName: string }) {
      ...
      <div className="sb-logo">
        <div className="row">
          ...
          <div>
            ...
            <div style={{ fontSize: 10, color: "var(--text3)", fontWeight: 700, textTransform: "uppercase", letterSpacing: ".09em" }}>Employee</div>
          </div>
        </div>
      </div>
